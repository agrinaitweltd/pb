...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className="hidden lg:flex lg:flex-col lg:w-64 lg:min-h-screen lg:border-r"
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed left-0 top-0 h-screen w-64 z-50 flex flex-col transition-transform duration-300 shadow-2xl lg:hidden ${
